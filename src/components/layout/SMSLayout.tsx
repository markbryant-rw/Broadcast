...
import { MessageSquare, LogOut, Settings, Users, FileText, History, ChevronDown, LayoutDashboard } from 'lucide-react';
...
const smsNavigation = [
  { name: 'Prospecting', href: '/sms', icon: MessageSquare },
  { name: 'Contacts', href: '/sms/contacts', icon: Users },
  { name: 'Templates', href: '/sms/templates', icon: FileText },
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-64 bg-sidebar border-r border-sidebar-border">
        ...
        <div className="h-16 flex items-center gap-3 px-6 border-b border-sidebar-border">
          <Link to="/dashboard" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <span className="text-xl font-display font-bold text-sidebar-foreground">SMS</span>
          </Link>
        </div>
      ...
      <main className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="lg:hidden h-16 flex items-center justify-between px-4 border-b border-border bg-card">
          <Link to="/dashboard" className="flex items-center gap-3">
            ...
            <span className="text-xl font-display font-bold">SMS</span>
          </Link>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
